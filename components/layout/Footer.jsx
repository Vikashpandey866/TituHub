      ...
      <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[1.2fr_.8fr_.8fr_1fr]">
        ...
        <div>
          ...
          <div className="space-y-3 text-sm text-zinc-500">
            ...
            <div className="flex items-center gap-2"><Phone size={15} className="text-orange" /> +91 XXXXX XXXXX</div>
            <div className="flex items-center gap-2"><MapPin size={15} className="text-orange" /> India</div>
          </div>
          <div className="mt-5 flex gap-2">
            <Link href="https://instagram.com" className="rounded-lg border border-white/10 p-2 text-zinc-400 hover:border-orange hover:text-orange" aria-label="Instagram"><Instagram size={17} /></Link>
            <Link href="https://wa.me/919999999999" className="rounded-lg border border-white/10 p-2 text-zinc-400 hover:border-orange hover:text-orange" aria-label="WhatsApp"><MessageCircle size={17} /></Link>
