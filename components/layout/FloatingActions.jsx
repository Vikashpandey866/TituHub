...
export default function FloatingActions() {
  ...
  return (
    <div className="fixed bottom-[calc(env(safe-area-inset-bottom)+6rem)] right-3 z-[2100] flex flex-col items-end gap-2 sm:bottom-6 sm:right-6">
      ...
      <Link href={whatsappUrl} target="_blank" rel="noreferrer" className="flex h-11 w-11 items-center justify-center rounded-full border border-emerald-400/30 bg-emerald-500/20 text-emerald-300 shadow-glow backdrop-blur-xl transition hover:scale-105 sm:h-12 sm:w-12" aria-label="WhatsApp">
